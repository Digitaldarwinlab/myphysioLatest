...
export const physioRegister = async (details, dispatch) => {
  ...
  try {
    const response = await fetch(
      process.env.REACT_APP_API + "/register_physio_v1/",
      {
...
export const physioUpdate = async (details, dispatch) => {
  ...
  if (tempData["landline"] === "") delete tempData["landline"];
  ...
  try {
    const response = await fetch(
      process.env.REACT_APP_API + "/update_profile/",
      {
        credentials: "same-origin",
        method: "PUT",
        headers: headers,
...
export const searchPhysio = async (value) => {
  try {
    ...
    const encodedData = Encode({ query: value });
    const response = await fetch(
      process.env.REACT_APP_API + "/physio-filter_v1/",
      {
        method: "POST",
        headers: headers,
        body: JSON.stringify(encodedData),
...
export const getPhysioList = async () => {
  try {
    ...
    const encodedData = Encode({ id: id });
    const response = await fetch(
      process.env.REACT_APP_API + "/get_physio_v1/",
      {
        method: "GET",
        headers: headers,
      }
...
export const getPhysio = async (physio_id) => {
  ...
  try {
    const response = await fetch(
      process.env.REACT_APP_API + "/get_single_physio/",
      {
        headers: headers,
        method: "POST",
...
export const getClincList = async () => {
  try {
    ...
    const response = await fetch(
      process.env.REACT_APP_API + "/clinic_list_v1/",
      {
        method: "GET",
        headers: headers,
      }
...
export const searchClinic = async (value) => {
  ...
  try {
    ...
    const response = await fetch(
      process.env.REACT_APP_API + "/search_clinic_v1/",
      {
        method: "POST",
        headers: headers,
        body: JSON.stringify(encodedData),
