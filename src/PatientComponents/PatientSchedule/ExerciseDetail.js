                  ...
                  <Col className="right-box">
                    <div className="instructions" id="instructions">
                      ...
                      >
                        ...
                        <h5>
                          {location.state.repArr[index].set}
                          </h5>
                        </Descriptions.Item>
                      ...
                      <p></p>
                      <Descriptions column={{ xxl: 1, xl: 1, lg: 1, md: 1, sm: 1, xs: 1 }} title={<h3>Step By Step Instructions</h3>} >
                        <Descriptions.Item label="1">
                          <h5>
                        {exercise.instruction1}
                          </h5>
                        </Descriptions.Item>
                        <Descriptions.Item label="2">
                        <h5>
                        {exercise.instruction2}
                          </h5>
                        </Descriptions.Item>
                      </Descriptions>
