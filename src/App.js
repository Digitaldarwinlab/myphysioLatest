...
const PostAssesment = lazy(()=> import("./EnterpriseNew/PostAssesment/PostAssesment"))
const EnterpriseExerciseDetail = lazy(() => import("./EnterpriseNew/PatientComponents/PatientSchedule/ExerciseDetail.js"));
const EnterpriseAI = lazy(() => import('./EnterpriseNew/PatientComponents/PatientAI/PatientAI'));
const EnterpriseSchedule = lazy(() => import("./EnterpriseNew/PatientComponents/PatientSchedule/PatSchedule"));
const EnterpriseRoute = lazy(() => import("./components/PrivateRoute/EnterpriseRoute.js"));
const ConsultForm = lazy(() => import("./EnterpriseNew/ConsultForm/ConsultForm"));
const EnterpriseRegister = lazy(() => import("./components/Enterprise/EnterpriseRegister.js"));
const EmployeeRegister = lazy(() => import("./components/Enterprise/EmpoyeeRegister.js"));
const organizationList = lazy(() => import("./components/Enterprise/OrganzationList.js"));
const EmployeeList = lazy(() => import("./components/Enterprise/EmployeeList.js"));
const ViewClinic = lazy(()=>import('./components/Physio/ClinicRegister/ViewClinic'))
const ClinicList = lazy(() => import("./components/Physio/ClinicRegister/ClinicList.js"));
const AromWithouthAi = lazy(() => import("./components/Assesment/Arom-withouth-ai.js"));
const Appointment = lazy(() => import("./components/NewSchedule/Appointment.js"));
...
const App = () => {
	...
	useEffect(() => {
		if(isAuthenticated()){
			let a = [process.env.REACT_APP_MAIN_JS_URL,"https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.2/jspdf.min.js","https://mozilla.github.io/pdf.js/build/pdf.js","https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js","https://kit.fontawesome.com/1ee1e3b82c.js"]
			a.map((i)=>{
