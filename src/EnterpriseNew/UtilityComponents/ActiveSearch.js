...
import { ASSESSMENT_STATE_CHANGE, EPISODE_STATECHANGE } from "../Store/Episode/episode"
import { getEpisodeDetails } from './../care-plan/carePlanIndex';
import {BsSearch} from 'react-icons/bs'
import './Activesearch.css'
import {Form} from 'antd' 
import { CARE_PLAN_CLEAR_STATE } from '../Store/care-plan-reducers/care-plan-action';
   ...
   // console.log(PatientData)
    ...
    return (
        <div className="mb-4">
            ...
            <input type="text"  value={text} className="px-4 py-2 input-field "
