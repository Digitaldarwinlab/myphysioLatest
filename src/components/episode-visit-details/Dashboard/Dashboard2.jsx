...
const Dashboard = (props) => {
  ...
  useEffect(() => {
    ...
    async function data() {
      ...
      // console.log(main)
      let combine = await combinedItems(main);
      console.log(combine)
      await combine.forEach(async (e) => {
        ...
        we.forEach(async (val) => {
          let exercise_alloted = await getData(
            val,
            e["value"][0][0][exDate.indexOf(val)]["exercise_alloted"],
            exDate,
            null
          );
      ...
      await combine.forEach(async (e) => {
        ...
        we.forEach(async (val) => {
          let reps_alloted = await getData(
            val,
            e["value"][0][0][exDate.indexOf(val)]["reps_alloted"],
            exDate,
            null
          );
      ...
      await combine.forEach(async (e) => {
        ...
        we.forEach(async (val) => {
          let set_alloted = await getData(
            val,
            e["value"][0][0][exDate.indexOf(val)]["set_alloted"],
            exDate,
            null
          );
      ...
      await combine.forEach(async (e) => {
        ...
        we.forEach(async (val) => {
          let exercise_completed = await getData(
            val,
            e["value"][0][0][exDate.indexOf(val)]["exercise_completed"]
              ? e["value"][0][exDate.indexOf(val)][exDate.indexOf(val)]["exercise_completed"]
              : "-",
            exDate,
            parseInt(e["value"][0][0][exDate.indexOf(val)]["exercise_completed"]) > 3
              ? "remaining"
              : parseInt(e["value"][0][0][exDate.indexOf(val)]["exercise_completed"]) === 3
              ? "pending"
              : "completed"
      ...
      await combine.forEach(async (e) => {
        ...
        we.forEach(async (val) => {
          let set_completed = await getData(
            val,
            e["value"][0][0][exDate.indexOf(val)]["set_completed"]
              ? e["value"][0][0][exDate.indexOf(val)]["set_completed"]
              : "-",
            exDate,
            parseInt(e["value"][0][0][exDate.indexOf(val)]["set_completed"]) > 3
              ? "remaining"
              : parseInt(e["value"][0][0][exDate.indexOf(val)]["set_completed"]) === 3
              ? "pending"
              : "completed"
      ...
      await combine.forEach(async (e) => {
        ...
        we.forEach(async (val) => {
          let reps_completed = await getData(
            val,
            e["value"][0][0][exDate.indexOf(val)]["reps_completed"]
              ? e["value"][0][0][exDate.indexOf(val)]["reps_completed"]
              : "-",
            exDate,
            parseInt(e["value"][0][0][exDate.indexOf(val)]["reps_completed"]) > 2
              ? "remaining"
              : parseInt(e["value"][0][0][exDate.indexOf(val)]["reps_completed"]) === 2
              ? "pending"
              : "completed"
