        ...
        {!allocatePlan ? (
          <Row className="mt-4 border">
            <Col
              ...
              sm={24}
              xs={24}
              className="gray-border ant-filter-hidden"
            >
            ...
            <Col
              ...
              sm={24}
              xs={24}
              className="px-2 py-2 gray-border careplan_drawer"
            >
              <Tabs
              ...
              >
                <TabPane
                  tab={
                    <span className="iconClass2">
                      <i className="fas fa-running iconClass3"></i> Exercises
                    </span>
                  }
                  key="2"
                >
                ...
                <TabPane
                  tab={
                    <span className="iconClass2">
                      <RiLayout6Fill className="iconClass3" /> Templates
                    </span>
                  }
                  key="1"
                >
            ...
            <Col md={24} lg={24} xl={19} sm={24} xs={24}>
              <TopScroll />
            </Col>
          </Row>
        ) : (
