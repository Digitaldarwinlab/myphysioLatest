...
const PhysioRegisteration2 = (props) => {
  ...
  const handleBlur = (e) => {
    ...
    if (key === "email") {
      ...
      if (error.error) {
        dispatch({
          type: VALIDATION,
          payload: { error: " Regd_no " + error.error },
        });
      }
    } else if (
      key == "expertise_1" ||
      ...
      if (error.error) {
        ...
        dispatch({
          type: VALIDATION,
          payload: { error: "Expertise " + newErr },
        });
      }
    }
  };
  ...
  const handleSubmit = (value) => {
    ...
    if (validation.checkEmailValidation(data.email).error) {
      dispatch({
        type: VALIDATION,
        payload: { error: validation.checkEmailValidation(data.email).error },
      });
      window.scrollTo({
        top: 0,
        behavior: "smooth",
  ...
  return (
    <>
      ...
      <h3 className="page-heading" id="page-heading">
        <i class="fas fa-user-plus"></i> Physiotherapist{" "}
      </h3>
      <StepBar src={svg} />
      <Title level={4} className="border mb-0 p-2 my-2">
        Other Information
      </Title>
          ...
          <Row gutter={[20, 20]} style={{ marginBottom: "15px" }}>
            ...
            <Col md={24} lg={8} sm={24} xs={24}>
              <FormInput
                ...
                placeholder="Physio Registered Id 2"
            ...
            <Col md={24} lg={8} sm={24} xs={24}>
              ...
              >
                {dropdownValue.Degree !== undefined && (
                  <Select
                    placeholder="Physio Degree"
          ...
          <Row gutter={[20, 20]} style={{ marginBottom: "15px" }}>
            <Col md={24} lg={8} sm={24} xs={24}>
              ...
              <Form.Item
                ...
                name="expertise_1"
                rules={[
                  { required: true, message: `Please Select Expertise 1` },
                ]}
              >
                {dropdownValue.Expertise !== undefined && (
                  <Select
                    placeholder="Expertise 1"
                    className="input-field w-100"
            ...
            {state.physioRegisterReducer.expertise_1 !== "Others" ? (
              <>
                <Col md={24} lg={8} sm={24} xs={24}>
                  <Form.Item
                    label={
