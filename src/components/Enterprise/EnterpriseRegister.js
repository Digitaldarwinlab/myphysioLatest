    ...
    return (
        <>
            ...
            <h3 className="page-heading" id="page-heading" ><i className="fas fa-arrow-left"
                    ...
                    role="button"></i><i className="fas fa-clinic-medical"></i> <b> Organization Registration </b></h3>
            ...
            <Form style={{ marginTop: '40px', marginLeft: '1%' }} onFinish={handleSubmit} form={form} name="control-hooks" autoComplete="off" layout="vertical" >
                ...
                <Row justify="center">
                    ...
                    <Col span={2}> <Button
                        //  className=" m-2"    
                        style={{ borderRadius: "10px", backgroundColor: '#2d7ecb' }} htmlType="submit" >Submit</Button></Col>
                </Row>
            </Form>
        </>
    )
