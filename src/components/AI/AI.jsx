...
const allNewJoints = [
  ...
  { value: 2, label: "L Elbow Flex" },
  { value: 3, label: "R Elbow Flex" },
  { value: 4, label: "L Hip Fwd Flex" },
  { value: 5, label: "R Hip Fwd Flex" },
  ...
  { value: 10, label: "L Lateral Side Flex" },
  { value: 11, label: "R Lateral Side Flex" },
  { value: 12, label: "L Wrist" },
  { value: 13, label: "R Wrist" },
  { value: 14, label: "L Ankle" },
  { value: 15, label: "R Ankle" },
  { value: 16, label: "L Hip Abd/Add" },
  { value: 17, label: "R Hip Abd/Add" },
  { value: 18, label: "Cervical Fwd Flex" },
];
const joints = [
  { value: 0, label: "L Shoulder Abd/Add" },
  { value: 1, label: "R Shoulder Abd/Add" },
