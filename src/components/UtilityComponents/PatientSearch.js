...
import {
  ...
  EPISODE_STATECHANGE,
} from "../../contextStore/actions/episode.js";
...
const PatientSearch = (props) => {
  ...
  const SuggestionHandler = (text) => {
    ...
    let pdata = PatientData.filter((val, ind) => {
      return val.pp_patm_id.toString() === text;
    });
    ...
    if (props.carePlan) {
      ...
      dispatch({
        type: "NAME",
        payload: { name: pdata[0].first_name + " " + pdata[0].last_name },
      });
  ...
  return (
    <div>
      <input
        ...
        className=" py-2 input-field modalInputs "
              ...
              <div className="search-bar">
                {
                  <div className="search-item" id="search-item">
                    <h5
                      className="ActiveSearch p-2 input-field mt-2"
                      onMouseOver={focus}
                      onMouseOut={defocus}
                      id={value[3]}
