      ...
      tableData1.map((item) => {
        if (item.joint !== "select") {
          if (item.min > item.max) {
            ...
            dispatch({
              type: VALIDATION,
              payload: { error: "Min value should not greater than Max value" },
            });
            document
              .getElementById(
                item.id + item.joint + item.min + item.max + "min"
  ...
  const columns1 = [
    {
      ...
      render: (text, record, index) => (
        <>
          {dropdownValue["Arommanualjoints"] !== undefined && (
            <>
              {dropdownValue["Arommanualjoints"].Anterior !== undefined && (
                <Select
                ...
                >
                  {dropdownValue["Arommanualjoints"].Anterior.map((item) => (
    ...
    },
    {
      ...
      render: (text, record, index) => (
        <InputNumber
          ...
          min={MinMax[record.joint].min}
          max={MinMax[record.joint].max}
          //  style={{ width: 120 }}
          //   value={text}
    ...
    },
    {
      ...
      render: (text, record, index) => (
        <>
          <Button
            className="delete_arom_btn"
            onClick={() => deleteRow1(record.id)}
            type="link"
          >
  ...
  const columns2 = [
    {
      ...
      render: (text, record, index) => (
        <>
          {dropdownValue["Arommanualjoints"] !== undefined && (
            <>
              {dropdownValue["Arommanualjoints"].left !== undefined && (
                <Select
                  name={"form_select1" + record.id}
                  ref={(ref) => {
                    ref2 = ref;
                ...
                >
                  {dropdownValue["Arommanualjoints"].left.map((item) => (
                    <Option key={item} value={item}>
                      {item}
                    </Option>
                  ))}
  ...
  const columns3 = [
    {
      ...
      render: (text, record, index) => (
        <>
          {dropdownValue["Arommanualjoints"] !== undefined && (
            <>
              {dropdownValue["Arommanualjoints"].right !== undefined && (
                <Select
                  name={"form_select1" + record.id}
                  ref={(ref) => {
                    ref3 = ref;
                ...
                >
                  {dropdownValue["Arommanualjoints"].right.map((item) => (
                    <Option key={item} value={item}>
                      {item}
                    </Option>
                  ))}
