...
const AROM = () => {
    ...
    const columns1 = [
        ...
        },
        {
            ...
            render: (text, record, index) => (
                <>
                    <Button className="btn-level-2-1x bg-theme-1x btn-1x" onClick={() => deleteRow1(record.id)} type="link">
                        <img className='icons-1x' src={Delete} width="25px" />
                    </Button>
                </>
            ),
        },
    ...
    const columns2 = [
        ...
        },
        {
            ...
            render: (text, record, index) => (
                <>
                    <Button className="btn-level-2-1x bg-theme-1x btn-1x" onClick={() => deleteRow2(record.id)} type="link">
                        <img className='icons-1x' src={Delete} width="25px" />
                    </Button>
                </>
            ),
    ...
    const columns3 = [
        ...
        },
        {
            ...
            render: (text, record, index) => (
                <>
                    <Button className="btn-level-2-1x bg-theme-1x btn-1x" onClick={() => deleteRow3(record.id)} type="link">
                        <img className='icons-1x' src={Delete} width="25px" />
                    </Button>
                </>
            ),
                    ...
                    >
                        <Panel header="Anterior" key="1">
                            <div>
                                ...
                                <Row style={{ margin: "14px 14px 0 0" }} justify="end">
                                    <Button className="btn-level-2-1x bg-theme-1x btn-1x" type="link" onClick={onConfirm1}>
                                        <img className='icons-1x' src={Add} width="25px" />
                                    </Button>
                                </Row>
                            </div>
                        </Panel>
                        <Panel header="Lateral-L" key="2">
                            <div>
                                ...
                                />
                                <Row style={{ margin: "14px 14px 0 0" }} justify="end">
                                    <Button className="btn-level-2-1x bg-theme-1x btn-1x" type="link" onClick={onConfirm2}>
                                        <img className='icons-1x' src={Add} width="25px" />
                                    </Button>
                                </Row>
                            </div>
                        ...
                        <Panel header="Lateral-R" key="3">
                            <div>
                                ...
                                />
                                <Row style={{ margin: "14px 14px 0 0" }} justify="end">
                                    <Button className="btn-level-2-1x bg-theme-1x btn-1x" type="link" onClick={onConfirm3}>
                                        <img className='icons-1x' src={Add} width="25px" />
                                    </Button>
                                </Row>
                            </div>
