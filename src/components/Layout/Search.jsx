...
<NavLink to="/pateints/new">
        ...
        <Col style={{display:'none'}} className="pag_mob" md={24} sm={24} xs={24}>
          <Table style={{width:'100%'}} locale={locale} loading={newLoading} scroll={{ x: scroll }} pagination={{ pageSize: 8,size:"small",position:['none', 'bottomCenter'] }} bordered columns={columns} dataSource={patientData} />
        </Col>
          {/* {show_password_modal()} */}
      </Row>
      </>)
