...
import { Typography, Select, Row, Col, Button, Form, Space, Input } from "antd";
...
console.log(state.BasicDetails.City)
  ...
  return (
    <>
      ...
      <h1 className="page-heading" id="page-heading">
      ...
      <StepBar src={svg} />
      <Title level={3} className="border mb-0 p-2">
        Contact Information
      </Title>
                  ...
                  <>
                    {stateList.length > 0 ? (
                      ...
                      <Input
                        ...
                        value={state.BasicDetails.State}
                        onChange={(value) => {
                          handleChange("State", value.target.value);
                        }}
                        defaultValue={state.BasicDetails.State}
                      />
                    )}
                  </>
                )}
                  ...
                  <>
                    {cityList.length > 0 ? (
                      ...
                      <Input
                        ...
                        value={state.BasicDetails.City}
                        onChange={(value) => {
                          handleChange("City", value.target.value);
                        }}
                        defaultValue={state.BasicDetails.City}
                      />
                    )}
                  </>
                )}
