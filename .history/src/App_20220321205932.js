				...
				<div className="padT-0">
					...
					<div className={
						...
						<Switch>
							...
							<PatEnterpriseRouteientRoute exact path="/patient/enterprise/dashboard/1" component={EnterprisePatient1} />
							...
							<PatientRoute exact path="/patient/enterprise/muscle-selection" component={Body} />
							<PatientRoute exact path="/quiz" component={Quiz} />
							<PatientRoute exact path="/PoseTest" component={Pose} />
							<PatientRoute exact path="/post-assesment" component={PostAssesment} />
							<PatientRoute exact path="/enterprise/schedule" component={EnterpriseSchedule} />
