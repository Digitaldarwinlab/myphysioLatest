...
const PatientVideoCallIndex = lazy(() => import('./PatienttComponents/Patient-video-call/patient-video-con.js'));
const Logout = lazy(() => import('./components/userAuth/Logout.js'));
const PatientDashboard = lazy(() => impor('./PatientComponents/patientDashboard'));
const PatientSchedule = lazy(() => import(''))
