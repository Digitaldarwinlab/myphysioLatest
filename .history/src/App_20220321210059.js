				...
				<div className="padT-0">
					...
					<div className={
						...
						<Switch>
							...
							<EnterpriseRoute exact path="/enterprise/quiz" component={Quiz} />
							<PatientRoute exact path="/enterprise/PoseTest" component={Pose} />
							<PatientRoute exact path="/enterprise/post-assesment" component={PostAssesment} />
