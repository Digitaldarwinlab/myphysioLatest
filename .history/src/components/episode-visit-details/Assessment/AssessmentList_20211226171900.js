                                ...
                                <Col span={24} className="px-3">
                                    ...
                                    {AssesmentData.length === 0 ? <p className="fw-bold">No Assesment Present..</p> : (
                                        <>
                                            ...
                                            <div className=" border mb-3 mt-3">
                                            {data.physical_assessement.Subjective&&data.physical_assessement.Subjective.length>0&&<> <Descriptions.Item label="" span={3}><b><u>Subjective </u></b></Descriptions.Item><Row gutter={[10, 10]} className="px-4 py-2">
