                                            ...
                                            <div className=" border mb-3 mt-3">
                                                ...
                                                <Row gutter={[10, 10]} className="px-4 py-2">
                                                    <Descriptions>
                                                        ...
                                                        {data.physical_assessement.Subjective&&data.physical_assessement.Subjective.map(data=>)<><Descriptions.Item label="" span={3}><b><u>Subjective </u></b></Descriptions.Item>
