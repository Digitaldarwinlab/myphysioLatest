                                            ...
                                            <div className=" border mb-3 mt-3">
                                                ...
                                                <Row gutter={[10, 10]} className="px-4 py-2">
                                                    <Descriptions>
                                                        ...
                                                        <Descriptions.Item label="Past Medical History" span={}> {data.physical_assessement.past_medical_history&&data.physical_assessement.past_medical_history.length>0&&data.physical_assessement.past_medical_history.map(p=>`${p+" ,"}`)}</Descriptions.Item>
