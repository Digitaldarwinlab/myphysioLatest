        ...
        <>
            ...
            <Row>
                ...
                <Col  lg={2} md={4} sm={24} xs={24}>
                    <Link to="/physio/list" title="Physio List" className="link text-blue navlink physios" id="navlink">
            ...
            <Form  onFinish={handleSubmit} form={form} name="control-hooks" autoComplete="off" layout="vertical" >
                ...
                <Row className="text-center" justify="center" style={{marginBottom:'15px'}}>
                    <Col >
                   <Link to='/dashboard'><Button className="me-2  reg-btn"  style={{borderRadius:'10px'}} >Cancel</Button></Link>
                    </Col>
                    <Col >
                    <Button className="me-2   reg-btn" style={{backgroundColor:'#41A0A2',borderRadius:"10px"}}   onClick={handleReset}>Reset</Button>
                    </Col>
                    <Col >
                    <Button className="me-2 btncolor reg-btn"  htmlType="submit">Next</Button>
                    </Col>
                </Row>
