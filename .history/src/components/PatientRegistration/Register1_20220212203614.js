    ...
    return (
        <>
            ...
            <Form className="BasicInformation" onFinish={onFinish} style={{marginTop:'2%'}} layout="vertical" onFinishFailed={onFinishFailed} form={form} name="control-hooks">
                ...
                <Row className="text-center new-pat-btn" justify="center">
                    <Col >
                  <Link to='/dashboard'>  <Button className="me-2 " style={{borderRadius:'10px'}} >Cancel</Button></Link>
                    </Col>
                    <Col>
                    <Button className="me-2 new-pat-btn" style={{backgroundColor:'#41A0A2',borderRadius:"10px"}}  onClick={handleReset}>Reset</Button>
                    </Col>
                    <Col >
                    {/* Dipsikha start 23/10 */}
                    <Button className="button1 new-pat-btn" id="bnid" style={{color: "white"}}  htmlType="submit">Next</Button>
                    </Col>
                </Row>
