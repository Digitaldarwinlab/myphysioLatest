...
import { ASSESMENT_CLEARSTATE, STATECHANGE, ASSESMENT_ADD_SUBJECTIVE, ASSESSMENT_REMOVE_SUBJECTIVE, ASSESSMENT_SUBJECTIVE } from "../../contextStore/actions/Assesment"
...
// import {ASSESSMENT_ADD_SUBJECTIVE} from './'
...
const Assesment1 = (props1) => {
  ...
  const handleChange = (key, value, id = 0) => {
    ...
    else if (key === "Duration" || key === "occuption") {
  ...
  const MedicationIncrease = () => {
    dispatch({ type: ASSESMENT_ADD_SUBJECTIVE, payload: { type: "subjective" } })

  }
  // Medication form decrease handler
  const MedicationDecrease = () => {
    dispatch({ type: ASSESSMENT_REMOVE_SUBJECTIVE, payload: { type: "subjective" } });
  }
      ...
      <div className="border mb-3 mt-3" style={{ background: '#fff', marginTop: '10px', padding: '20px' }}>
        ...
        <div className="container-fuild">
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <select className="form-select"
                        name="occupation" id={occupation} data-id={index}
                        aria-label="Default select example"
                        value={state.FirstAssesment.subjective[index].occupation}
                        // onChange={(name, value, index) => console.log("")}
                        onChange={(name, value, index) => handleChange("subjective", value, index)}
                        index={index}
                      >
          ...
          <div className="row">
            <div className="col">
              ...
              {
                state.FirstAssesment.subjective.length > 0 && (
                  <ButtonComponent
                    Increase={MedicationIncrease}
                    length={state.FirstAssesment.subjective.length}
        ...
        <div className="container-fuild">
          ...
          <div className="row" name="past_check" >
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" id="inlineCheckbox5" name="Medication"
              onChange={(e) => handleChange("Medication", e.target.checked)} value={state.FirstAssesment.Medication} />
              <label class="form-check-label" for="inlineCheckbox5">Medication</label>
              <input class="mx-5" type="text" id="medicationText" placeholder="Medication" />
            </div>
