...
// console.log(item.uid);
    ...
    >
        ...
        <form onSubmit={handleAuhtorizationSubmit}>
            ...
            <center>
                        <Button type="primary" htmlType="submit" className="userAuthbtn" onClick={() => {}}>
                            Verify OTP
                        </Button>
                        </center>
                        <center>
                        <Button type="primary" htmlType="button" className="userAuthbtn" onClick={() => {const message = await getOTP({
            "uid":item.uid
            });
            setMessage(message.message);}}>
                            Resend OTP
